...
1. Склонируйте репозиторий с GitHub:
   ...
   ```bash
   git clone https://github.com/Denqc/transport11.git
...
4. Запустите файл Dashboard.py для запуска Дашборда. Дашборд будет доступен по адресу: http://127.0.0.1:8050/
   ![Dash](https://github.com/Denqc/transport1/blob/development/dashScreen.jpg)
...
![TelegramBotScreenShot](https://github.com/Denqc/transport1/blob/development/telegrambotscreenshot.jpg)
...
![BPMN](https://github.com/Denqc/trasport1/blob/development/BpmnTelegramBot.jpg)

## Ссылки

1. Профиль GitHub: https://github.com/Denqc
2. Проект Dashboard: https://github.com/Denqc/transport11
